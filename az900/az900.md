...
Export a resource management template with parameters description in template [Read More](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/syntax).
