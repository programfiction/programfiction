...
---
## Azure Advisor
   Azure advisor for automated deployments & optimize once resources. Its not only suggests you the optimize options but also it helps optimizing cost. Provides personalized filter and export reports for user. Also can provide alerts and digests. 
